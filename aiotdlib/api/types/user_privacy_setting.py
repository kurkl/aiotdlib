...
class UserPrivacySettingAllowPrivateVoiceAndVideoNoteMessages(UserPrivacySetting):
    ...
    ID: str = Field("userPrivacySettingAllowPrivateVoiceAndVideoNoteMessages", alias="@type")

    @staticmethod
    def read(q: dict) -> UserPrivacySettingAllowPrivateVoiceAndVideoNoteMessages:
        return UserPrivacySettingAllowPrivateVoiceAndVideoNoteMessages.construct(**q)
